...
//         },
//       });
//       return data.products || []; // Ensure data is an array
//     },
//   });

//   // Fetch Total Product Count for Pagination
//   const { data: countData } = useQuery({
//     queryKey: ["products-count", search, selectedBrand, selectedCategory],
//     queryFn: async () => {
...
//         },
//       });
//       return data.count || 0; // Fallback to 0 if count isn't present
//     },
//   });
...
//     if (value > 0 && value <= numberOfPages) setCurrentPage(value);
//   };
...
const Products = () => {
  ...
  console.log("Product Data:", products); // Debugging to see the product data.
      ...
      <div className="grid mt-16 grid-cols-1 gap-5 md:grid-cols-2 lg:grid-cols-3">
        {products.length > 0 ? (
          ...
          <p className="text-center col-span-full text-gray-600">
            No products found. Try changing filters or search criteria.
          </p>
        )}
      </div>
